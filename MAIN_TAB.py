...
def regims3():
    new_regims_f = open(main_path_data + "\\regims3.json", 'r')
    new_regims = json.load(new_regims_f)
    regims=[]
    for k, v in new_regims.items():
        if v['avtomat'] == 'off':
                                            ...
                                            children=[
                                                ...
                                                dbc.Col(style={'width': '4%',
                                                        ...
                                                        children=[html.Button('del',
                                                                       ...
                                                                       "background-color": "tomato",
                                                                        ...
                                                                        id={'type': 'Delete_NewRegim_btn_reg3',
                                                                            'index': k},
                                                                        n_clicks=0)]),
                                                dbc.Col(style={'width': '7%',
                                                               'margin': '0',
                                                ...
                                                dbc.Col(style={'width': '13%',
                                                        ...
                                                        children=[html.Button('save',style={
                                                                            ...
                                                                            'max-width': '45px',
                                                                            'max-height': '40px'},
                                                                              id={'type': 'Save_NewRegim_btn_reg3',
                                                                                  'index': k},
                                                                              n_clicks=0)]),
                                                dbc.Col(style={'width':'13%',
                                                               'margin': '0',
